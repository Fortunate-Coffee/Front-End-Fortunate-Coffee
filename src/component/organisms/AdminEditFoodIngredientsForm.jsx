                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center">
                    <div className="flex flex-row justify-between my-1">
                        ...
                        <div className="flex items-center justify-start">
                            ...
                            <input type="number" id="qty" name="qty" min={1} value={formData.qty} onChange={handleChange} required className="mt-1 p-2 border border-gray-300 rounded-md w-1/2 shadow-lg" />
                        </div>
                    </div>
